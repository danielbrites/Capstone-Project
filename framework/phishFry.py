...
'''Adapted from the FreshPhish Framework as a continuation on the ideas within the FreshPhish documentation. This is also a new direction and updated code to reflect changes in code and rules recently established by enitities such as Google.'''
...
#             print("unMatched domains = {}".format(unMatchedDomains))
    ...
    def hasDoubleSlash(self):
        ...
        self.phishScore['doubleSlashRedirecting'] = retVal
        return retVal
    ...
    def usingIPAddress(self):
        ...
        # This one was completely redone and is working now. Now it actually works...

        retVal = 0
        try:
            r = regex.match('^http[s]?:\/\/((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])', self.url)    
            if r == None:
                retVal = 1
            else:
                retVal = -1
        except:
            print("usingIPAddress" , "Unknown Error")
...
def Measuringfeatures(fileName):
...
#                 break
            ...
            gPh.havingIP()
            printFormat("func", "urlOfAnchor", "")
            gPh.getAnchorResult()
            printFormat("func", "redirect", "")
            gPh.getRedirect()  #Page Rank """
            printFormat("func", "linksInTags", "")
            gPh.getLinksInTags()
            printFormat("func", "domainRegistrationLength", "")
            gPh.domainRegistrationLength()
            printFormat("func", "havingAtSymbol", "")
            gPh.hasAtSymbol()
            printFormat("func", "doubleSlashRedirecting", "")
            gPh.hasDoubleSlash()
            printFormat("func", "port", "")
            ...
            gPh.DNSRecord()
            printFormat("func", "statisticalReport", "")
            gPh.RequestURL()
            ...
            resultFile.write("{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}\n".format(
                            gPh.phishScore['havingIP'],gPh.phishScore['urlOfAnchor'],gPh.phishScore['redirect'],
                            gPh.phishScore['linksInTags'],gPh.phishScore['domainRegistrationLength'],
                            gPh.phishScore['havingAtSymbol'],
                            gPh.phishScore['doubleSlashRedirecting'],gPh.phishScore['port'],gPh.phishScore['popUpWindow'],
                            gPh.phishScore['httpsToken'],gPh.phishScore['sfh'],gPh.phishScore['onMouseOver'],
                            gPh.phishScore['abnormalURL'],gPh.phishScore['favicon'],gPh.phishScore['urlLength'],
                            gPh.phishScore['getageOfDomain'],gPh.phishScore['prefixSuffix'],gPh.phishScore['usingIPAddress'],
                            gPh.phishScore['havingSubDomain'],gPh.phishScore['dnsRecord'],gPh.phishScore['statisticalReport'],
                            gPh.phishScore['requestURL'] ,
                            site))
